...
public class ProtoTypePatternMain {
	...
	/*
	 * Creational Pattern
	 * this pattern takes advantage of the fact that cloning an existing object gives
	 * faster performance than creating anther instance of that object.
	 * This is basically the same code as the Flyweight pattern, except for returning cloned objects
	 */
