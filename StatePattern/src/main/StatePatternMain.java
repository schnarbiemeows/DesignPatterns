...
public class StatePatternMain {
	...
	/**
	 * * Behavioral pattern this pattern uses a Context object which holds a State
	 * interface. The Context object actually represents a real object(like a
	 * stereo) StereoRemote is an example of using state without using this pattern.
	 * 
