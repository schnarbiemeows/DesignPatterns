...
public class FilteringIteratorTest {
	...
	/**
	 * String tests - compare the size of the filtered lists with the size of the
	...
	/**
	 * Person tests - compare the size of the filtered lists with the size of the
	 * expected output list
	 */
	@Test
	...
	// Car tests - compare the size of the filtered lists with the size of the
	// expected output list
	@Test
