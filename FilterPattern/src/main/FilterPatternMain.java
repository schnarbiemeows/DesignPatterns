...
public class FilterPatternMain {
	...
	/**
	 * * Structural design pattern filter a list of items using conditionals that
	 * implement a common Criteria interface, and also implementers that can chain
	 * together individual conditionals
