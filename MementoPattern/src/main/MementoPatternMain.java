...
public class MementoPatternMain {
	...
	/**
	 * * Behavioral Pattern The Memento pattern is used to restore state of an
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"First saved State: " + originator.getState().getId() + " , created on " + originator.getDateCreated());
		originator.getStateFromMemento(careTaker.get(1));
		System.out.println("Second saved State: " + originator.getState().getId() + " , created on "
				+ originator.getDateCreated());
