...
public class ChainOfResponsibilityPatternMain {
	 ...
	 * who can handle the request INFO<DEBUG<ERROR, and all levels can display items
	 * their level and higher so INFO can also do DEBUG and ERROR
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		// consoleLogger and fileLogger will display this, because they are level 1 and
		// 2
